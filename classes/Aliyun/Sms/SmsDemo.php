...
class SmsDemo
{
    ...
    public static function getAcsClient()
    {
        ...
        $accessKeyId = $config['AliyunSMS']['AccessKeyId']; // AccessKeyId
        $accessKeySecret = $config['AliyunSMS']['AccessKeySecret']; // AccessKeyId
     ...
     * @return stdClass
     */
    public static function sendSmsVerCode($phone,$code='') {
        ...
        $request->setSignName("行列资讯");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_159783581");
