    ...
    <nav class="layui-header hc-header">
        <div class="layui-main">
            ...
            <ul class="layui-nav">
                ...
                <li class="layui-nav-item hc-hide-sm"> <a href="../views/book_center.php">图书资源</a> </li>
                <li class="layui-nav-item hc-hide-sm layui-this"> <a href="../views/notice_list.php">新闻动态</a> </li>
