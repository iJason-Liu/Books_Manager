...
) ENGINE=MyISAM AUTO_INCREMENT=129 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户注册信息记录';
...
) ENGINE=MyISAM AUTO_INCREMENT=10023 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='馆藏图书的数据列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1023 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图书类别信息';
...
CREATE TABLE `student` (
  ...
  PRIMARY KEY (`stu_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2121502101 DEFAULT CHARSET=utf8 COMMENT='学生表';
...
) ENGINE=MyISAM AUTO_INCREMENT=2113956201 DEFAULT CHARSET=utf8 COMMENT='教师表';
...
CREATE TABLE `user_type` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1005 DEFAULT CHARSET=utf8 COMMENT='角色信息表';
