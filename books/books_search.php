                    ...
                    <ul class="layui-nav layui-nav-tree" lay-filter="demo">
                        ...
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd class="layui-this"><a href="../books/books_search.php"><i class="layui-icon layui-icon-search"></i>&nbsp;图书查询</a></dd>
                                <!-- 图书点击量，借阅次数 -->
    ...
    <script>
        layui.use(['table', 'laypage', 'form'], function() {
            ...
            table.render({
                elem: '#dataList',
                type: 'POST',
                url: '../books/search_booksData.php',  //渲染人气图书列表
            ...
            $('#search').on('click', function (){
                ...
                if(keywords === ''){
                    ...
                    table.reload('dataList', {
                        url: '../books/search_booksData.php',
                        page: false, //开启分页
                        where: {
                            keywords: keywords,
                            keywords_type: data.keywords_type
