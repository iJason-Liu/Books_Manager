                ...
                <div class="layui-btn-container">
                    <?php
                        if($usertype == '图书管理员'||$usertype == '超级管理员') {
                            echo "<button class='layui-btn layui-btn-sm' lay-event='exportBook'><i class='layui-icon layui-icon-addition'></i>新增图书</button>";
                            echo "<button class='layui-btn layui-btn-sm' lay-event='exportList'><i class='layui-icon layui-icon-addition'></i>批量导入</button>";
