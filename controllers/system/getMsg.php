<?php
    ...
    if($result){
        echo json_encode(array('code' => 200, 'msg' => 'success', 'state' => mysqli_num_rows($result2), 'count' => mysqli_num_rows($result), 'data'=> mysqli_fetch_all($result,MYSQLI_ASSOC)),JSON_UNESCAPED_UNICODE);
    }else{
