<?php
    ...
    $self_id = $_SESSION['user_id'];  //当前用户自己的id

    $json = file_get_contents('php://input');
    $data = json_decode($json,true);
    $id = $data['id'];  //被操作对象的用户id
    ...
    }else if($self_id != '19991011' && $id == '19991011'){
        echo json_encode(array('code' => 403, 'msg' => '您暂无权限对超级管理员设置！'),JSON_UNESCAPED_UNICODE); //无权限
    }else {
