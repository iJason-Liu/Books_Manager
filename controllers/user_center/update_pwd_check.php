<?php
    ...
    if($usertype == '学生'){
        $sql = "update student set password='$password' where cardNo='$id'";
    }else if($usertype == '教师'){
        $sql = "update teacher set password='$password' where cardNo='$id'";
        ...
        $sql = "update other_user set password='$password' where id='$id'";
    }
