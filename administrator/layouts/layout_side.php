        ...
        <div class = "layui-side layui-bg-black">
            <div class = "layui-side-scroll">
                ...
                <ul class = "layui-nav layui-nav-tree">
                    ...
                    <?php
                        if (!empty($item['lib_worker']))echo "layui-show"; else echo "layui-hide";
                    ...
                    <li class = "layui-nav-item
                    <?php
                        if (!empty($item['reader_list']) || !empty($item['reader_kind']))echo "layui-show"; else echo "layui-hide";
                    ...
                    <li class = "layui-nav-item
                    <?php
                        if (!empty($item['comment_center']) || !empty($item['comment_control']) || !empty($item['news_notice']))echo "layui-show"; else echo "layui-hide";
