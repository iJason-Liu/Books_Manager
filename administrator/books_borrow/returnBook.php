...
<body>
    <div class="layui-layout layui-layout-admin">
                    ...
                    <ul class="layui-nav layui-nav-tree" lay-filter="test">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <!-- 图书点击量，借阅次数 -->
                                <dd><a href="../books_source/rank_books.php"><i class="layui-icon layui-icon-praise"></i>&nbsp;人气图书</a></dd>
                                <?php
                                    if ($type_id == 1003 || $type_id == 1004) {
                        ...
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd class="layui-this"><a href="../books_borrow/returnBook.php"><i class="layui-icon layui-icon-prev-circle"></i>&nbsp;图书归还</a></dd>
                            </dl>
                        </li>
        ...
        <div class="layui-body">
            <!-- 内容主体区域 -->
            <div style="padding: 15px;">图书归还！</div>
        </div>
