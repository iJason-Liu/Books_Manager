...
<body>
    <div class="layui-layout layui-layout-admin">
                    ...
                    <ul class="layui-nav layui-nav-tree" lay-filter="test">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd><a href="../books_source/book_kind.php"><i class="layui-icon layui-icon-form"></i>&nbsp;图书类别</a></dd>
                                <?php
                                    if ($type_id == 1003 || $type_id == 1004) {
                        ...
                        ?>">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="layui-this"><a href="../comment/comment_center.php"><i class="layui-icon layui-icon-reply-fill"></i>&nbsp;评论中心</a></dd>
        ...
        <div class="layui-body">
            <!-- 内容主体区域 -->
            <div style="padding: 15px;">评论中心！</div>
        </div>
