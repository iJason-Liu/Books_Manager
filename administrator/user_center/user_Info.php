        ...
        <div class="layui-body">
            ...
            <div id="form_tab">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" id="name" value="<?php echo $row['name'] ?>" placeholder="请输入姓名" lay-verify="required" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">当前身份:</label>
                    <div class="layui-input-inline">
                        <input disabled type='text' name='usertype' value='<?php echo $row['user_type'] ?>' class='layui-input color'>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item <?php if ($row['user_type'] == '学生' || $row['user_type'] == '教师') echo "layui-show"; else echo "layui-hide";?>">
                    <label class="layui-form-label"><span style="color: #ff0000;">*</span>学 院:</label>
                    <div class="layui-input-block">
                        <input type="text" name="department" id="department" value="<?php echo $row['department'] ?>" placeholder="请输入学院" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item <?php if ($row['user_type'] == '学生' || $row['user_type'] == '教师') echo "layui-show"; else echo "layui-hide";?>">
                    <label class="layui-form-label"><span style="color: #ff0000;">*</span><?php if($row['user_type']=='教师')echo '管理班级：';else echo '班级：'; ?></label>
                    <div class="layui-input-block">
                        <input type="text" name="class" id="class" value="<?php echo $row['class'] ?>" placeholder="请输入班级" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color: #ff0000;">*</span>联系电话:</label>
                    <div class="layui-input-block">
                        <input type="tel" name="mobile" id="mobile" value="<?php echo $row['mobile'] ?>" placeholder="请输入联系电话" lay-verify="required" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-hide" id="tip">
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block" style="margin-top: 45px;">
                        ...
                        <button type="button" class="layui-btn" id="submit"  value="修改信息">修改信息</button>
                        <!--<button type="button" class="layui-btn layui-hide" name="go" id="submit" lay-submit value="确定">确 定</button>-->
                    </div>
                </div>
            </div>
                <?php
        ...
        layui.use(['layer', 'form'], function() {
            ...
            $('#submit').on('click',function (){
                ...
                if(!reg.test(data.mobile)){
                    ...
                    $.ajax({
                        url: '../../controllers/user_center/submit_info',
                        type: 'POST',
            ...
            //                 $('#go').addClass('layui-hide');
            //                 $('#reset').removeClass('layui-hide');
