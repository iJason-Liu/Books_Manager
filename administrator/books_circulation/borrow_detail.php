<?php
    ...
    $other_sql = "select * from other_user where id='$card_id'";
    $other = mysqli_num_rows(mysqli_query($db_connect, $other_sql));
...
<body>
    ...
    ?>
        <div id="form_tab">
            ...
            <div class="layui-form-item <?php if ($user_type == '学生' || $user_type == '教师') echo "layui-show";?>">
