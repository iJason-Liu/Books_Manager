    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body">
            ...
            <script type="text/html" id="mark">
                <span class="{{d.mark == '逾期归还' ? 'use' : 'have'}}">{{d.mark}}</span>
            </script>
    ...
    <script type="text/javascript">
        layui.use(['table', 'form', 'util'], function() {
            ...
            table.render({
                elem: '#dataList',
                type: 'POST',
                url: '../../controllers/books_circulation/record_data.php',
            ...
            table.on('tool(tab)', function(obj) {
                ...
                let url = '../books_circulation/borrow_detail.php?card_id='+card_id;
                // console.log(obj);
                if (obj.event === 'detail') {
                    layer.open({
