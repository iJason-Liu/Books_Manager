                    ...
                    <ul class="layui-nav layui-nav-tree" lay-filter="test">
                        ...
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                ?>
                                <!-- 包含查询，书库名，编号，位置 -->
                                <dd class="layui-this"><a href="../books_source/book_stack.php"><i class="layui-icon layui-icon-diamond"></i>&nbsp;书库信息</a></dd>
                            </dl>
                        </li>
                        <li class="layui-nav-item">
    ...
    <script>
        ...
        layui.use(['table', 'layer'], function() {
            ...
            table.render({
                elem: '#dataList',
                type: 'POST',
                url: '../../controllers/books_source/book_stackData.php',
