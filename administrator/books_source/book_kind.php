                    ...
                    <ul class="layui-nav layui-nav-tree" lay-filter="test">
                        ...
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <?php
                                    if ($type_id == 1003 || $type_id == 1004) {
                                        echo "<dd class='layui-this'><a href='../books_source/book_kind.php'><i class='layui-icon layui-icon-form'></i>&nbsp;图书类别</a></dd>";
                                    }
                                ?>
                                <!-- 包含查询，书库名，编号，位置 -->
    ...
    <script>
        ...
        layui.use(['table', 'layer'], function() {
            ...
            table.render({
                elem: '#dataList',
                type: 'POST',
                url: '../../controllers/books_source/book_kindData.php',
                ...
                switch (obj.event) {
                    case 'del':
                        if(data.length === 0){
                            ...
                            layer.confirm('确认删除这 ' + num + ' 个分类吗？', function (index) {
                                $.ajax({
                                    url: '../../controllers/books_source/delete_book_kind.php',
                                    type: 'POST',
                    ...
                    case 'add':
                        layer.open({
                            ...
                            content: '../books_source/add_book_kind.php'
                        })
                        break;
                }
            })
