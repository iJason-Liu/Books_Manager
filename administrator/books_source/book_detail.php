        ...
        <div id="form_tab">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block" style="margin-top: 45px;">
                    ...
                    <button type="button" class="layui-btn" name="go" id="go" value="编辑">编 辑</button>
                </div>
            </div>
        </div>
            <?php
            ...
            layui.use(['layer'], function() {
                ...
                $('#go').click(function (){
                    if(usertype === '学生' || usertype === '教师'){
                        ...
                        setTimeout("location.href = '../books_source/update_book.php?id=<?php echo $id ?>'",1500)
                    }
                })
            })
        </script>
