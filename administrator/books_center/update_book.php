...
<!--    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">-->
	...
	<body style="background: url('../../skin/images/bg3.jpg') top center no-repeat; background-size:cover">
        <form class="layui-form" action="../../controllers/books_center/update_book_check.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
        <?php
...
<!--                <div class="layui-form-mid layui-word-aux">单位：本</div>-->
        ...
        <script>
            layui.use(['upload', 'form', 'layer'], function() {
                ...
                upload.render({
                    elem: '#bookcover',
                    url: '../../controllers/books_center/update_book_check.php', //上传接口
