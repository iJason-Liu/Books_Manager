...
<!--    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">-->
	...
	<body style="background: url('../../skin/images/bg3.jpg') top center no-repeat; background-size:cover">
        <form class="layui-form" action="../../controllers/books_center/add_book_check.php" method="post" enctype="multipart/form-data">
        <div id="form_tab">
...
<!--        <script src="../../skin/js/jquery-3.3.1.min.js"></script>-->
        <script>
            layui.use(['upload', 'form', 'layer'], function() {
                ...
                upload.render({
                    elem: '#bookcover',
                    url: '../../controllers/books_center/upload_bookCover.php', //上传接口
