<?php
    ...
    if ($user_type == '学生'){
        ...
        $sql1 = "select * from other_user where id='$id'";
    }
        ...
        <div id="form_tab">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input disabled type="text" name="id" id="id" value="<?php echo $row['cardNo'] == '' ? $row['id'] : $row['cardNo'] ?>" class="layui-input color">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item layui-hide">
                ...
                <div class="layui-input-block">
                    <input disabled type="text" name="user_type" id="user_type" value="<?php echo $row['user_type'] ?>" class="layui-input color">
                </div>
            </div>
            <div class="layui-form-item">
