    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs layui-this"><a href="../system/help_guide.php">帮助中心<span class="layui-badge">1</span></a></li>
            </ul>
        ...
        <div class="layui-body">
            <!-- 内容主体区域 -->
            <div style="padding: 15px;">帮助中心，使用文档！</div>
            <a href="../../upload/pdf/Mac键盘快捷键.pdf" target="_blank"><button class="layui-btn">查看PDF文件</button></a>
        </div>
