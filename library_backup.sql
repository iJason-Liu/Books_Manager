...
) ENGINE=InnoDB AUTO_INCREMENT=10021 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='馆藏图书的数据列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1022 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图书类别信息';
...
CREATE TABLE `lib_worker` (
  ...
  `worker_name` varchar(25) NOT NULL COMMENT '馆员名字',
  `sex` bit(1) DEFAULT NULL COMMENT '性别，0为男，1为女',
  `mobile` int(11) DEFAULT NULL COMMENT '馆员电话',
  `worker_type` varchar(30) NOT NULL COMMENT '身份类别',
...
) ENGINE=InnoDB AUTO_INCREMENT=1005 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户类型表';

-- ----------------------------
-- Records of user_type
-- ----------------------------
BEGIN;
INSERT INTO `user_type` (`type_id`, `usertype_name`) VALUES (1002, '图书管理员');
INSERT INTO `user_type` (`type_id`, `usertype_name`) VALUES (1003, '学生');
INSERT INTO `user_type` (`type_id`, `usertype_name`) VALUES (1004, '教师');
INSERT INTO `user_type` (`type_id`, `usertype_name`) VALUES (1001, '超级管理员');
COMMIT;
