...
) ENGINE=MyISAM AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
BEGIN;
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10014, '《盗墓笔记》', '南派三叔', '玄幻类', '开远出版社', 180, 28, '测试测四', '../images/cover/test_1.webp', '2023-03-07 17:12:35', '2023-03-07 17:12:35', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10015, '《教父》', '[美] 马里奥·普佐', '文学类', '美国出版社', 20, 18, '测试数据测试数据', '../images/cover/中文测试.webp', '2023-03-07 17:25:43', '2023-03-07 17:25:43', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10009, '《八千里路云和月》', '白先勇', '文学类', '中国友谊出版公司', 45, 15, '阿斯卡很勤快我好困', '../images/cover/test_2.webp', '2023-03-07 17:12:45', '2023-03-07 17:12:45', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10008, '《万古江河：中国历史文化的转折与开展》', '许倬云', '著作类', '湖南人民出版社', 41, 56, '清华校长送给每一位2019级新生的书，极具世界眼光的中国通史 大历史叙述的经典之作。', NULL, '2022-12-30 17:08:42', '2023-03-07 17:08:48', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10016, '《茶花女》', ' [法国]小仲马', '文学类', '未知', 520, 20, '未知', NULL, '2022-10-12 17:08:32', '2023-03-07 17:08:41', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10007, '《人间值得》', '[日]中村恒子', '励志类', '北京日报出版社', 46, 25, '宝藏奶奶的人生36条感悟，正面解读工作、家庭、人际关系、孤独、死亡等人生课题，给人直面生活的勇气，愿每个人都能从人间失格直至人间值得！罗丹、三毛、史铁生坚信的生活理念。愿你遍历山河，仍觉人间值得！', NULL, '2023-03-02 17:08:24', '2023-03-07 17:08:29', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10018, '《妖神记》', '发飙的蜗牛', '玄幻类', '新华出版社', 28, 100, '增加添加时间，也就是上架时间，\r\n心潮澎湃，无限幻想，迎风挥击千层浪，少年不败热血！', NULL, '2023-01-24 17:08:49', '2023-03-07 17:08:57', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10019, '《炼气十万年》', 'Jason', '冒险类', '未知', 35, 23, '为突破炼气万归元闭关三万年，谁曾想炼气9999层都没能突破。正所谓一层为渣，两层为蠢，三层为废。然而万归元炼气9999层，却无敌天下，轰杀一切。无敌一时爽，一直无敌一直爽。作为活了三万年的老祖，唯一的烦恼就是无敌太寂寞。', NULL, '2023-03-07 17:13:47', '2023-03-07 17:13:47', NULL, b'0');
INSERT INTO `book_list` (`book_id`, `book_name`, `author`, `book_type`, `publisher`, `price`, `number`, `mark`, `book_cover`, `create_date`, `update_date`, `save_position`, `status`) VALUES (10020, '《成龙历险记》', '老爹', '冒险类', '未知', 52, 28, '图书借鉴', NULL, '2023-03-07 17:09:15', '2023-03-07 17:09:15', NULL, b'0');
COMMIT;
