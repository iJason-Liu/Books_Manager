...
//    die();
    ...
    if($usertype == '学生'){
        ...
        $sql = "update student set name='$name',sex='$sex',department='$department',class='$class',mobile='$mobile' where cardNo='$cardNo'";
    }else if($usertype == '教师'){
        $sql = "update teacher set name='$name',sex='$sex',department='$department',class='$class',mobile='$mobile' where cardNo='$cardNo'";
