...
<body>
    <div class="layui-layout layui-layout-admin">
                                ...
                                <dd>
                                    <li class="layui-nav-item layui-nav-itemed">
                                        ...
                                        <dl class="layui-nav-child layui-nav-child-c">
                                            ...
                                            <dd class="layui-this"><a href="../reader/reader_info_teacher.php"><i class="layui-icon layui-icon-username"></i>&nbsp;教师档案</a></dd>
                                        </dl>
                                    </li>
                                </dd>
        ...
        <div class="layui-body">
            <!-- 内容主体区域 -->
            <div style="padding: 15px;">管理员在此处进行教师档案的管理，导入！</div>
        </div>
