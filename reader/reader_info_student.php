...
<body>
    <div class="layui-layout layui-layout-admin">
                            ...
                            <dl class="layui-nav-child">
                                <dd>
                                    <li class="layui-nav-item layui-nav-itemed">
                                        ...
                                        <dl class="layui-nav-child layui-nav-child-c">
                                            <dd class="layui-this"><a href="../reader/reader_info_student.php"><i class="layui-icon layui-icon-username"></i>&nbsp;学生档案</a></dd>
        ...
        <div class="layui-body">
            <!-- 内容主体区域 -->
            <div style="padding: 15px;">管理员在此处进行学生档案的管理，导入！</div>
        </div>
