        ...
        <div class="layui-body">
            ...
            <script type="text/html" id="toolbarDemo">
                <div class="layui-btn-container">
                    ...
                    <button class='layui-btn layui-btn-sm' lay-event="moreImport"><i class='layui-icon layui-icon-addition'></i>批量导入</button>
    ...
    <script>
        layui.use(['table', 'laypage', 'form'], function() {
            ...
            table.render({
                elem: '#dataList',
                type: 'POST',
                url: '../reader/reader_listData.php',
                ...
                cols: [
                    [{
                        ...
                        field: 'password',
                        width: 320,
                        title: "<img style='width: 24px;height: 16px;cursor: pointer;margin-top: -1px;' title='显示' class='showPwd' src='../images/showPwd.png' />密码",
                        align: 'center',
                        templet: '#password'
                    }, {
                        field: 'sex',
            ...
            $('#search').on('click', function (){
                ...
                if(keywords === ''){
                    ...
                    table.reload('dataList', {
                        url: '../reader/search_readerData.php',
                        page: false, //开启分页
                        where: {
                            keywords: keywords,
                            keywords_type: data.keywords_type
